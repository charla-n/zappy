/*
** edi.c for zappy in /home/charla_n/projects/zappy_git/zappy/server/src
** 
** Made by nicolas charlas
** Login   <charla_n@epitech.net>
** 
** Started on  Fri Jun 21 12:11:29 2013 nicolas charlas
** Last update Thu Jul  4 15:56:58 2013 arthur jansen
*/
...
int		edi(__attribute__((unused))t_srv *srv, void *ptr,
		    ...
		    __attribute__((unused))char *cmd2)
{
  ...
  while (tmp && g->length_graphic)
      ...
      if (tmp->type == FD_GRAPHIC)
	{
	  ...
	  if (write_circ(&tmp->buff_circ_w, "edi ") == FAILURE ||
